(function () {
  ...
  async function initLiquidSphere() {
    ...
    try {
      ...
      function draw(timestamp) { easedX += (pointerX - easedX) * 0.045; easedY += (pointerY - easedY) * 0.045; const time = timestamp * 0.00045; deform(time); mesh.rotation.y = timestamp * 0.00012 + easedX * 0.18; mesh.rotation.x = easedY * 0.12; renderer.render(scene, camera); }
